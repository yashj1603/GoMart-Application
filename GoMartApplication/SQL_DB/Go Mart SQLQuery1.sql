...
select top 1 AdminID,Password,FullName from tblAdmin where AdminID='Yash16' and Password='12345'
...
select top 1 SellerName,SellerPass from tblSeller where SellerName='Akash' and SellerPass='12345'
...
select * from tblAdmin
select AdminID from tblAdmin where AdminID='Yash16'
